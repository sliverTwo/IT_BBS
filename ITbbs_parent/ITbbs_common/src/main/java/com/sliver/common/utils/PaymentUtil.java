...
public class PaymentUtil {
    ...
    public static boolean verifyCallback(YeePay yeePay,String keyValue){
        String sNewString = PaymentUtil.hmacSign(yeePay.toVerify(), keyValue);
        return sNewString.equals(yeePay.getHmac());
    }
