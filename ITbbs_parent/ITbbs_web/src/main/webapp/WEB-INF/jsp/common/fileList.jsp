        ...
        <script>
            layui.use('table', function () {
                ...
                table.render({
                    elem: '#fileList'
                    , height: 500
                    , url: '${path}/file/listFile.do' //数据接口
                    , page: true //开启分页
                    , cols: [[ //表头
                        {field: 'filename', title: '文件名',width:'13%'}
                        , {field: 'introduce', title: '介绍',width:'40%'}
                        , {field: 'createtime', title: '上传时间',width:'15%',align: 'center'
                            , templet: function (d) {
                                return new Date(d.createtime).toLocaleString();
                            }
                        }
                        , {field: 'username', title: '上传者', align: 'center',width:'10%'}
                        , {field: 'downloadNum', title: '下载次数', align: 'center',width:'8%'}
                        , {field: 'score', title: '积分',align: 'center',width:'5%'}
